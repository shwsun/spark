...
if __name__ == "__main__":
    """
        Usage: spark-submit --master "yarn" --jars /install-files/mysql-connector-java-5.1.49/mysql-connector-java-5.1.49-bin.jar inv-stream-ad.py  
    """
